        ...
        <div className="workspace-main">
            ...
            <footer className="App-main-left-footer">
                <div className="App-main-left-bottom">
                    <button className="App-main-left-bottom-button" onClick={userId ? () => setAccountModalOpen(true) : () => setSignUpModalOpen(true)}>
                    ...
                    <button className="App-main-left-bottom-button">
